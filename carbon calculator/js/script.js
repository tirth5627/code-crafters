$(document).ready(function() {
	...
	$("#calculate-btn").on("click", function() {
      	var calculateAndDisplayScore = function() {
			const element = document.getElementById('sectionscroll'); // Replace with your element's ID  
			element.scrollIntoView({ behavior: 'smooth' }); // Use 'smooth' for a smooth scrolling effect  
